...
// Source: github.com/{{ cookiecutter.github_username }}/{{ cookiecutter.project_name }}/internal/users/domain (interfaces: PasswordService)
//
// Generated by this command:
//
//	mockgen -package mock_db -destination internal/users/mock/password.go github.com/{{ cookiecutter.github_username }}/{{ cookiecutter.project_name }}/internal/users/domain PasswordService
//
